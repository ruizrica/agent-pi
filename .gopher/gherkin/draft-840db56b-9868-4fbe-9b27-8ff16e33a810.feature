Feature: Commander Prompt
  ...
  Scenario: Handle error case — Status
    When the request triggers status
    Then the response should indicate the error condition
    And the error message should describe "status"

  Scenario: Handle error case — <progress>
    When the request triggers <progress>
    Then the response should indicate the error condition
    And the error message should describe "<progress>"
