Feature: Cleanup Viewer Html
  ...
  Scenario: Handle error case — >Error: 
    When the request triggers >Error: 
    Then the response should indicate the error condition
    And the error message should describe ">Error: "

  Scenario: Handle error case — </span>
    When the request triggers </span>
    Then the response should indicate the error condition
    And the error message should describe "</span>"
