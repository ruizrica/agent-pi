Feature: Qa Rico Html
  Module with 5 exported items
  ...
  Scenario: Handle error case — This.style.display=
    When the request triggers this.style.display=
    Then the response should indicate the error condition
    And the error message should describe "this.style.display="

  Scenario: Handle error case — <div class=
    When the request triggers <div class=
    Then the response should indicate the error condition
    And the error message should describe "<div class="
