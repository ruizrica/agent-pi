// ABOUTME: Vulnerability scanner protection installer — generates portable AI security guard files for any project.
...
import type { ProjectProfile } from "./vuln-scanner-engine.ts";
...
function generateCICheck(profile: ProjectProfile): string {
	...
	return `# AI Vulnerability Security Check — Automated security scanning for AI-powered projects
# Generated by /vuln-scanner install
