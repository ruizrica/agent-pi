...
import { generateSpecViewerHTML } from "../lib/viewers/spec-viewer-html.ts";
...
describe("shared viewer scrollbar styles", () => {
	...
	it("injects the shared CSS into all targeted public and private viewer templates", () => {
		const expectedSources: Array<[string, string]> = [
			["lib/viewers/plan-viewer-html.ts", "../viewer-scrollbar-styles.ts"],
			["lib/viewers/spec-viewer-html.ts", "../viewer-scrollbar-styles.ts"],
			["lib/completion-report-html.ts", "./viewer-scrollbar-styles.ts"],
			["lib/viewers/reports-viewer-html.ts", "../viewer-scrollbar-styles.ts"],
			["lib/viewers/research-viewer-html.ts", "../viewer-scrollbar-styles.ts"],
			["lib/security/security-report-html.ts", "../viewer-scrollbar-styles.ts"],
			["lib/viewers/test-viewer-html.ts", "../viewer-scrollbar-styles.ts"],
